...
// Bản offline (scripts/build-offline.mjs) đặt NEXT_PUBLIC_GI_BASE=/gi/ để dùng ảnh đã tải sẵn trên máy
export const ASSET = process.env.NEXT_PUBLIC_GI_BASE || "https://gi.yatta.moe/assets/UI/";
export const MONSTER_ASSET = `${ASSET}monster/`;
