...
export const trackFile = (it) => it.file || (it.track ? `${it.src === "R" ? "Rikai" : "Katsudou"}/${it.track}.mp3` : null);
export const trackLabel = (it) => (!it.track && !it.file ? "🔊 Giọng máy" : it.src ? `${it.src === "R" ? "Rikai" : "Katsudou"} ${it.track}` : `Track ${it.track}`);
