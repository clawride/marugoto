...
const AV = (icon) => `${ASSET}UI_AvatarIcon_${icon}.png`;
...
export const PROGRAMS = [
  ...
  { id: "boss", group: "extra", href: "/boss", ico: "⚔️", lv: "A2-1", jp: "ボス", name: "Thử Thách Boss", host: "Yae Miko", avatar: `${ASSET}monster/UI_MonsterIcon_Shougun_Mitakenarukami.png`, color: "211,188,142",
  ...
  { id: "nghe", group: "extra", href: "/nghe", ico: "🎧", lv: "A2-1", jp: "聴解", name: "Thử Thách Nghe", host: "Băng Thần", avatar: `${ASSET}monster/UI_MonsterIcon_HerraFrost.png`, color: "160,215,255",
