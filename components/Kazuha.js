...
export const KZ = {
  hub: [
    ...
    "Người Việt có một lợi thế: âm Hán Việt. Nhớ được nửa chữ thôi, ngươi vẫn đoán được cả chữ.",
  ],
  ...
  memo: "Nhìn chữ, nhớ nghĩa, nhớ âm Hán Việt. Ba điều ấy như ba cánh lá phong.",
  ...
  guess: "Chưa nhớ hết cũng không sao. Nhìn phần biểu âm, nghĩ đến âm Hán Việt, rồi đoán như một thi nhân.",
